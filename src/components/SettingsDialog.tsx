...
import { LocalModelPluginManager } from '@/features/canvas/localModels';
        ...
        >
          ...
          <div className="w-[180px] bg-bg-dark border-r border-border-dark flex flex-col">
            ...
            <nav className="flex-1">
              ...
              `}
              >
                <span className="text-sm">{t('settings.plugins')}</span>
              </button>
                ...
                <div className="ui-scrollbar flex-1 space-y-4 overflow-y-auto p-6">
                  ...
                  <div className="rounded-lg border border-border-dark bg-bg-dark p-4 space-y-2 text-sm">
                    ...
                    <p className="text-text-dark">
                      ...
                      <a
                        href="https://framecraft-pro.netlify.app/"
                        target="_blank"
                        rel="noreferrer"
                        className="text-accent hover:underline"
                      >
                    ...
                    <p className="text-text-dark">
                      ...
                      <a
                        href="https://github.com/lorryjovens-hub/-FrameCraft-Pro-"
                        target="_blank"
                        rel="noreferrer"
                        className="text-accent hover:underline break-all"
                      >
                        https://github.com/lorryjovens-hub/-FrameCraft-Pro-
                      </a>
                    </p>
                  </div>
