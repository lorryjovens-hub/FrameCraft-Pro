...
export type ToolIconKey = 'crop' | 'annotate' | 'split' | 'inpaint' | 'brush';
export type ToolEditorKind = 'form' | 'crop' | 'annotate' | 'split' | 'inpaint' | 'brush' | 'multi-angle-render' | 'product-photography' | 'lighting-adjustment';
