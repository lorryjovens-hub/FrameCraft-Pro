  ...
  ({
    ...
    return (
      <div
        ...
        className={`nodrag relative bg-bg-dark/85 transition-colors contain-layout ${dragging
      ...
      >
        ...
        >
          {frame.imageUrl ? (
            <CanvasNodeImage
              ...
              placeholderSrc={frame.previewImageUrl ? resolveImageDisplayUrl(frame.previewImageUrl) : undefined}
              lazy
        ...
        <textarea
          ...
          className="ui-scrollbar nodrag nowheel h-10 w-full resize-none overflow-y-auto overflow-x-hidden border-0 border-t border-[rgba(255,255,255,0.12)] bg-bg-dark/90 px-2 py-1 text-[10px] leading-3 text-text-dark outline-none focus:border-accent"
        />
      </div>
    );
  }
...
export const StoryboardNode = memo(({ id, data, selected, width, height }: StoryboardNodeProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="mt-2 flex shrink-0 items-center justify-between gap-1.5">
        <div className="flex min-w-0 items-center gap-1.5">
          ...
          <div className="shrink-0 truncate text-[11px] text-text-muted/80">
            {gridRows}×{gridCols} | {totalFrames}格
          </div>
        </div>
        ...
        <div className="flex shrink-0 items-center gap-1.5">
          ...
          >
            ...
            <span className="truncate">{isPackingSingleImages ? '打包中...' : '打包下载'}</span>
          </UiButton>
          <UiButton
            size="sm"
            variant="primary"
          ...
          >
            ...
            <span className="truncate">{isExporting ? '导出中...' : '合并分镜'}</span>
          </UiButton>
        </div>
      </div>
        ...
        >
          <UiPanel className="p-3">
            <div className="space-y-3 text-xs text-text-muted">
              <label className="flex cursor-pointer items-center gap-2 rounded-md border border-[rgba(255,255,255,0.08)] bg-bg-dark/50 px-2.5 py-1.5 transition-colors hover:border-[rgba(255,255,255,0.14)]">
                <UiCheckbox
                  checked={exportOptions.showFrameIndex}
                  onCheckedChange={(checked) => patchExportOptions({ showFrameIndex: checked })}
                />
                <span className="text-text-dark">显示分镜序号</span>
              </label>
              ...
              <label className="flex cursor-pointer items-center gap-2 rounded-md border border-[rgba(255,255,255,0.08)] bg-bg-dark/50 px-2.5 py-1.5 transition-colors hover:border-[rgba(255,255,255,0.14)]">
                ...
                />
                <span className="text-text-dark">显示分镜描述</span>
              </label>

              <div className="grid grid-cols-2 gap-2">
                <div>
                  <div className="mb-1.5 text-[11px]">图片填充</div>
                  <UiSelect
                ...
                <div>
                  <div className="mb-1.5 text-[11px]">序号前缀</div>
                  <UiInput
                ...
                <div>
                  <div className="mb-1.5 text-[11px]">描述位置</div>
                  <UiSelect
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  <div className="mb-1.5 text-[11px]">间距</div>
                  <UiInput
                    type="number"
                    min={0}
                    max={120}
                ...
                <div>
                  <div className="mb-1.5 text-[11px]">字号(%)</div>
                  <UiInput
                    type="number"
                    min={1}
                    max={20}
              ...
              <div className="grid grid-cols-2 gap-2">
                <label className="flex items-center gap-2 rounded-md border border-[rgba(255,255,255,0.08)] bg-bg-dark/50 px-2.5 py-1.5">
                  <span className="shrink-0 text-[11px]">背景</span>
                  <input
                    type="color"
                    value={exportOptions.backgroundColor}
                    onChange={(event) => patchExportOptions({ backgroundColor: event.target.value })}
                    className="h-6 w-full min-w-[40px] rounded border border-[rgba(255,255,255,0.14)] bg-transparent"
                  />
                </label>
                <label className="flex items-center gap-2 rounded-md border border-[rgba(255,255,255,0.08)] bg-bg-dark/50 px-2.5 py-1.5">
                  <span className="shrink-0 text-[11px]">文字</span>
                  <input
                    type="color"
